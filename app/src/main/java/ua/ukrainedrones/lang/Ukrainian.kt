...
internal val Ukrainian: Strings.StringSet = Strings.StringSet(
    ...
    settings = Strings.Settings(
        ...
        nightZoneSirenOverrideTitle = "Перевизначити вібрацію, використовувати канал сповіщень",
        nightZoneSirenOverrideDesc = "Зонні сповіщення дзвонять вночі навіть у вібро- чи беззвучному режимі. Вимкнено — звук слідує за налаштуваннями телефону.",
        nightOfficialSirenOverrideTitle = "Офіційні сповіщення перевизначають вібрацію",
        nightOfficialSirenOverrideDesc = "Офіційна тривога вночі дзвонить навіть у вібро- чи беззвучному режимі. Нічний рівень нижче визначає: вся область чи лише ваше місто.",
        nightOfficialAlertCityScopeTitle = "Міський рівень",
        nightOfficialAlertCityScopeDesc = "Вночі за замовчуванням — вся область. Увімкни, щоб сповіщало лише коли тривога у твоєму місті.",
