...
internal val Ukrainian: Strings.StringSet = Strings.StringSet(
    ...
    settings = Strings.Settings(
        ...
        sirenOverrideTitle = "Перевизначити вібрацію, використовувати канал сповіщень",
        ...
        fallingDebrisDelayDesc = "Keep a falling debris countdown in the all-clear notification and app footer after an alert lifts.",
...
nightSoundLabel = "Звук уночі",
         nightZoneSirenOverrideTitle = "Зонні сповіщення перевизначають вібрацію",
         nightOfficialSirenOverrideTitle = "Офіційні сповіщення перевизначають вібрацію",
    ...
    misc = Strings.Misc(
        ...
        showThreatIdsOnMapTitle = "Show threat IDs on map",
        showThreatIdsOnMapDesc = "Display the last 4 digits of each threat's ID beside its marker.",
        ...
        fillAlertRegionsDesc = "How alerting oblasts and districts are shown on the map while an official air-raid alert is active.",
        ...
        hdExplosionDesc = "Ускладнені ефекти вибуху для різних типів загроз — уламки, іскри, дим. Може впливати на продуктивність.",
        neutralizedTallyTitle = "Neutralized counter",
        neutralizedTallyDesc = "Show a notification counting threats resolved in your oblast while monitoring is running. Tapping replays the interceptions on the map — for morale!",
        neutralizedTallyAllUkraineTitle = "All of Ukraine",
        neutralizedTallyAllUkraineDesc = "Also count neutralized threats anywhere in Ukraine to boost nationwide spirit.",
        alarmEpisodeTallyTitle = "Alarm summary",
        alarmEpisodeTallyDesc = "When your oblast's alarm ends, show what was neutralized during that alarm. Separate from the running counter above. Alarms can be frequent and the sound may get annoying — you can silence it in Android notification settings once it arrives.",
        alarmEpisodeTitleFormat = "%1\$s: alarm summary",
        alarmEpisodeBodyFormat = "%1\$s neutralized during the alarm. Tap to replay.",
        alarmEpisodeQuietText = "All quiet — nothing neutralized during this alarm.",
        moraleNote = "Morale features (visual effects, flybys, neutralized counters) are strictly for morale and keeping spirits up. In reality, a threat leaving the feed might have been shot down, fallen, or left radar coverage — but for Morale we celebrate them all as neutralized! 😉 These never affect alert accuracy. During an active air-raid alert, all Morale features yield immediately so sirens own your screen. When in doubt, always trust official sirens.",
