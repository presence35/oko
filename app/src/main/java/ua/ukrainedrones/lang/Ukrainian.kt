...
internal val Ukrainian: Strings.StringSet = Strings.StringSet(
    ...
    guide = Strings.Guide(
        ...
        guideLegendTitle = "Map colours",
        guideLegendSummary = "Official fills vs your personal zones.",
        guideLegendD1 = "Solid red fill — official air-raid alert (level red) for that oblast or district. Triggers banner and siren.",
        guideLegendD2 = "Solid yellow fill — tactical / artillery threat (level yellow) — illustrative only, never sirens, as on map.ukrainealarm.com.",
        guideLegendD3 = "Yellow ring — your outer alert zone (distance for slow threats, ETA for fast). Red disk — your inner zone. Follow your GPS/pinned city.",
        guideLegendD4 = "Rings are faint when idle, solid when a threat is inside that zone. Overlap with a red fill means both an official alert and your zone are active.",
