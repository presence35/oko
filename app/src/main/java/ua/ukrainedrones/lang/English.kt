...
internal val English: Strings.StringSet = Strings.StringSet(
    ...
    settings = Strings.Settings(
        ...
        nightZoneSirenOverrideTitle = "Override vibrate, use alarm channel",
        nightZoneSirenOverrideDesc = "Zone alerts ring at night even on vibrate/silent. Off — sound follows your phone's settings.",
        nightOfficialSirenOverrideTitle = "Official alerts override vibrate",
        nightOfficialSirenOverrideDesc = "Official alerts ring at night even on vibrate/silent. The night scope below decides whether the whole oblast or only your city rings.",
        nightOfficialAlertCityScopeTitle = "City level",
        nightOfficialAlertCityScopeDesc = "Whole oblast by default at night. Enable to alert only when your city is covered.",
