...
object AviationFlyby {
     ...
     * Gated by the master "Morale" switch ([moraleEnabled]) and the flyby sub-toggle
    ...
    fun nextShow(
        ...
        if (!visible || !moraleEnabled || !flybyEnabled) return null
    ...
    fun tapShow(
        ...
        if (!moraleEnabled || !flybyEnabled) return null
