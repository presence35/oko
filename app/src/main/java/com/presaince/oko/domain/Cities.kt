...
object Cities {
    ...
    internal val REGIONS: List<Region> = listOf(
        Region("Київськ", listOf(
            ...
            City("Бориспіль", 50.3506, 30.9553, CityTier.MEDIUM),
            City("Ірпінь", 50.5217, 30.2506),
            City("Фастів", 50.0767, 29.9184, CityTier.MEDIUM),
            City("Васильків", 50.1836, 30.3213),
            City("Обухів", 50.1300, 30.6180, CityTier.MEDIUM),
            City("Вишгород", 50.5826, 30.4883, CityTier.MEDIUM),
            ...
            City("Баришівка", 50.3593, 31.32, CityTier.MEDIUM, pop = 10294), // pop ~10294
            ...
            City("Славутич", 51.5225, 30.7181, CityTier.MEDIUM, pop = 24464), // pop ~24464
            City("Софіївська Борщагівка", 50.4093, 30.3591, CityTier.MEDIUM, pop = 25882), // pop ~25882
        ...
        Region("Одеськ", listOf(
            ...
            City("Білгород-Дністровський", 46.1947, 30.3484, CityTier.MEDIUM),
            City("Ізмаїл", 45.3503, 28.8348, CityTier.MEDIUM),
            City("Рені", 45.4571, 28.2867),
            City("Кілія", 45.4552, 29.2637),
            City("Овідіополь", 46.2450, 30.4413),
            City("Біляївка", 46.4829, 30.1985),
            City("Березівка", 47.2044, 30.9093, CityTier.MEDIUM),
            City("Роздільна", 46.8493, 30.0833, CityTier.MEDIUM),
            City("Арциз", 45.9919, 29.4183),
            City("Татарбунари", 45.8527, 29.6144),
            City("Подільськ", 47.7433, 29.5350, CityTier.MEDIUM),
            City("Балта", 47.9364, 29.6226),
            City("Болград", 45.6810, 28.6130, CityTier.MEDIUM),
            City("Ананьїв", 47.7220, 29.9580),
            City("Кодима", 48.1020, 29.1240),
            City("Саврань", 48.1320, 30.0820),
            City("Любашівка", 47.8370, 30.2630),
            City("Великодолинське", 46.3464, 30.579, CityTier.MEDIUM, pop = 13856), // pop ~13856
        ...
        Region("Львівськ", listOf(
            ...
            City("Новий Розділ", 49.4714, 24.1335, CityTier.MEDIUM, pop = 28304), // pop ~28304
            City("Новояворівськ", 49.9302, 23.5736, CityTier.MEDIUM, pop = 31366), // pop ~31366
        ...
        Region("Дніпропетровськ", listOf(
            ...
            City("Павлоград", 48.5170, 35.8730, CityTier.MEDIUM),
            ...
            City("Синельникове", 48.3180, 35.5190, CityTier.MEDIUM),
            ...
            City("Зеленодольськ", 47.555, 33.659, CityTier.MEDIUM, pop = 12692), // pop ~12692
            City("Інгулець", 47.7301, 33.2519),
            City("Нові Кодаки", 48.4867, 34.9564, CityTier.MEDIUM, pop = 15000), // pop ~15000
        ...
        Region("Харківськ", listOf(
            ...
            City("Ізюм", 49.2090, 37.2520, CityTier.MEDIUM),
            City("Куп'янськ", 49.7100, 37.6210),
            City("Златопіль", 49.3860, 36.2140, CityTier.MEDIUM),
            City("Балаклія", 49.4620, 36.8590),
            City("Богодухів", 50.1640, 35.5270, CityTier.MEDIUM),
        ...
        Region("Запорізьк", listOf(
            ...
            City("Пологи", 47.4820, 36.2540, CityTier.MEDIUM),
            City("Василівка", 47.4420, 35.2750),
            City("Приморськ", 46.7340, 36.3550),
            City("Оріхів", 47.5670, 35.7840),
            City("Гуляйполе", 47.6640, 36.2580),
            City("Вільнянськ", 47.9440, 35.4350, CityTier.MEDIUM),
            City("Кам'янка-Дніпровська", 47.4850, 34.4140, CityTier.MEDIUM),
        ...
        Region("Вінницьк", listOf(
            ...
            City("Калинівка", 49.4470, 28.5260, CityTier.MEDIUM),
            City("Тульчин", 48.6740, 28.8500, CityTier.MEDIUM),
            City("Ладижин", 48.6850, 29.2400, CityTier.MEDIUM),
        ...
        Region("Миколаївськ", listOf(
            ...
            City("Снігурівка", 47.0710, 32.7960, CityTier.MEDIUM),
            City("Ольшанське", 47.1990, 31.7970, CityTier.MEDIUM),
        ...
        Region("Херсонськ", listOf(
            ...
            City("Скадовськ", 46.1180, 32.9110, CityTier.MEDIUM),
            City("Олешки", 46.6290, 32.7230),
            City("Гола Пристань", 46.5250, 32.5260),
            City("Берислав", 46.8400, 33.4270, CityTier.MEDIUM),
            City("Таврійськ", 46.7500, 33.4380),
            City("Чаплинка", 46.3450, 33.5320),
            City("Велика Лепетиха", 47.1740, 33.9370),
            City("Нижні Сірогози", 47.0250, 34.3790, CityTier.MEDIUM),
            City("Антонівка", 46.6767, 32.7306, CityTier.MEDIUM, pop = 12777), // pop ~12777
        ...
        Region("Кіровоградськ", listOf(
            ...
            City("Новоукраїнка", 48.3150, 31.5250, CityTier.MEDIUM),
            City("Бобринець", 48.0590, 32.1580),
            City("Гайворон", 48.3390, 29.8480, CityTier.MEDIUM),
        ...
        Region("Полтавськ", listOf(
            ...
            City("Миргород", 49.9650, 33.6110, CityTier.MEDIUM),
        ...
        Region("Черкаськ", listOf(
            ...
            City("Золотоноша", 49.6680, 32.0400, CityTier.MEDIUM),
            City("Канів", 49.7510, 31.4700),
            City("Корсунь-Шевченківський", 49.4170, 31.2600, CityTier.MEDIUM),
            City("Звенигородка", 49.0780, 30.9690, CityTier.MEDIUM),
        ...
        Region("Житомирськ", listOf(
            ...
            City("Коростишів", 50.3180, 29.0590, CityTier.MEDIUM),
        ...
        Region("Рівненськ", listOf(
            ...
            City("Здолбунів", 50.5230, 26.2430, CityTier.MEDIUM),
            City("Березне", 50.9990, 26.7440),
            City("Радивилів", 50.1320, 25.2560, CityTier.MEDIUM),
            City("Володимирець", 51.4200, 26.1450, CityTier.MEDIUM),
            City("Корець", 50.6150, 27.1610),
            City("Дубровиця", 51.5720, 26.5630, CityTier.MEDIUM),
        ...
        Region("Чернівецьк", listOf(
            ...
            City("Вижниця", 48.2490, 25.1910, CityTier.MEDIUM),
        ...
        Region("Івано-Франківськ", listOf(
            ...
            City("Надвірна", 48.6340, 24.5700, CityTier.MEDIUM),
            City("Долина", 48.9740, 24.0020),
            City("Бурштин", 49.2570, 24.6350),
            City("Косів", 48.3150, 25.0950, CityTier.MEDIUM),
            City("Снятин", 48.4470, 25.5700),
            City("Городенка", 48.6700, 25.4990, CityTier.MEDIUM),
        ...
        Region("Сумськ", listOf(
            ...
            City("Охтирка", 50.3100, 34.8970, CityTier.MEDIUM),
            City("Ромни", 50.7500, 33.4870, CityTier.MEDIUM),
            ...
            City("Білопілля", 51.1470, 34.3070, CityTier.MEDIUM),
        ...
        Region("Чернігівськ", listOf(
            ...
            City("Новгород-Сіверський", 52.0040, 33.2620, CityTier.MEDIUM),
            City("Корюківка", 51.7780, 32.2640, CityTier.MEDIUM),
        ...
        Region("Донецьк", listOf(
            ...
            City("Слов'янськ", 48.8540, 37.6060),
            City("Бахмут", 48.5950, 38.0000, CityTier.MEDIUM),
            ...
            City("Волноваха", 47.5980, 37.4990, CityTier.MEDIUM),
            ...
            City("Комсомольське", 47.6639, 38.0775, CityTier.MEDIUM, pop = 11422), // pop ~11422
            City("Красногорівка", 48.0046, 37.5069, CityTier.MEDIUM, pop = 14666), // pop ~14666
        ...
        Region("Луганськ", listOf(
            ...
            City("Отаманівка", 48.3459, 39.6523, CityTier.MEDIUM, pop = 22449), // pop ~22449
            City("Перевальськ", 48.4392, 38.8284, pop = 24817), // pop ~24817
            City("Петрово-Красносілля", 48.2966, 38.8789, CityTier.MEDIUM, pop = 12642), // pop ~12642
            City("Станично-Луганське", 48.6625, 39.4836, CityTier.MEDIUM, pop = 12258), // pop ~12258
        ...
        Region("Закарпатськ", listOf(
            ...
            City("Берегове", 48.2050, 22.6400, CityTier.MEDIUM),
            City("Виноградів", 48.1410, 23.0330),
            City("Свалява", 48.5470, 22.9920),
            City("Рахів", 48.0500, 24.2000, CityTier.MEDIUM),
            City("Тячів", 48.0110, 23.5710, CityTier.MEDIUM),
            City("Іршава", 48.3160, 23.0370),
            City("Міжгір'я", 48.5280, 23.5070, CityTier.MEDIUM),
            City("Воловець", 48.7100, 23.1810),
            City("Великий Березний", 48.8940, 22.4600, CityTier.MEDIUM),
        ...
        Region("Волинськ", listOf(
            ...
            City("Ківерці", 50.8330, 25.4590, CityTier.MEDIUM),
            City("Любомль", 51.2240, 24.0360),
            City("Камінь-Каширський", 51.6210, 24.9580, CityTier.MEDIUM),
        ...
        Region("Крим", listOf(
            ...
            City("Джанкой", 45.7110, 34.3880, CityTier.MEDIUM),
            City("Алушта", 44.6760, 34.4100),
            City("Бахчисарай", 44.7520, 33.8600, CityTier.MEDIUM),
            City("Саки", 45.1340, 33.6000),
            City("Красноперекопськ", 45.9610, 33.7940, CityTier.MEDIUM),
            City("Армянськ", 46.1070, 33.6920),
            City("Щолкіне", 45.4260, 35.8250),
            City("Білогірськ", 45.0568, 34.6039, CityTier.MEDIUM, pop = 16428), // pop ~16428
            City("Буюк-Онлар", 45.2887, 34.1352, pop = 10244), // pop ~10244
            City("Гаспра", 44.4363, 34.1125, pop = 10310), // pop ~10310
            City("Гвардійське", 45.1169, 34.0219, CityTier.MEDIUM, pop = 12589), // pop ~12589
