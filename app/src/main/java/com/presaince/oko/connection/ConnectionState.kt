 ...
 *  instead of restarting its timers. Used only by [com.presaince.oko.source.SourceRegistry]. */
const val EPISODE_CONTINUITY_GRACE_MS = 3_000L

/** Offline-episode milestone signal, emitted once per episode by [com.presaince.oko.source.SourceRegistry].
 *  Transport ([com.presaince.oko.connection.ResilientConnectionSupervisor]) never emits it. */
