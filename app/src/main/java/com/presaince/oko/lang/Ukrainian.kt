...
internal val Ukrainian: Strings.StringSet = Strings.StringSet(
    ...
    settings = Strings.Settings(
        ...
        policyWhatIfFormat = "%1\$d sounds in the last 24h",
    ...
    misc = Strings.Misc(
        ...
        showBordersTitle = "Показати контури областей",
        showBordersDesc = "Малювати контури областей на карті.",
        showRegionBordersTitle = "Районні контури",
        showRegionBordersDesc = "Також малювати контури районів, тонші та світліші.",
