...
internal val Ukrainian: Strings.StringSet = Strings.StringSet(
    ...
    onboarding = Strings.Onboarding(
        ...
        wizardMoraleTitle = "Morale & Spirit",
        wizardMoraleDesc = "Visual effects, flybys, and tally to keep spirits high — purely for morale, not official kill confirmations! Tune in",
        wizardMoraleDescGearSuffix = "settings.",
    ...
    settings = Strings.Settings(
        ...
        notifyPolicyDesc = "Red always sounds the first time - this only quiets repeats.",
        ...
        policyWhatIfActualFormat = "%1\$d sounds in the last 24h",
        policyWhatIfEstimateFormat = "~%1\$d sounds in the last 24h",
...
nightSoundLabel = "Звук уночі",
    ...
    misc = Strings.Misc(
        ...
        hdExplosionTitle = "Деталізована вибухова анімація",
        ...
        gpsUnavailableFollowMe = "Позиції поки немає — визначаємо…",
    ...
    subtitles = Strings.Subtitles(
        ...
        onWord = "УВІМК",
        offWord = "ВИМК",
        moraleAnimationPrefix = "Анімація: ",
        moraleTallyOn = "Лічильник: УВІМК",
