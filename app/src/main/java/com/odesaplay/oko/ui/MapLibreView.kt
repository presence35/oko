...
import com.odesaplay.oko.AlertRegionMode
...
import com.odesaplay.oko.UA_PAN_MAX_LAT
import com.odesaplay.oko.UA_PAN_MAX_LON
import com.odesaplay.oko.UA_PAN_MIN_LAT
import com.odesaplay.oko.UA_PAN_MIN_LON
...
class MapLibreBridge(
    ...
    fun fromPixels(x: Float, y: Float): com.odesaplay.oko.engine.LatLng? {
        val m = map ?: return null
        val pt = m.projection.fromScreenLocation(PointF(x, y)) ?: return null
        return com.odesaplay.oko.engine.LatLng(pt.latitude, pt.longitude)
    }
